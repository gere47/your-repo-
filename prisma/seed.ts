...
//   // Get all roles and modules for permission assignment
...
//                'Timetable Management', 'Inventory Management', 'Reports & Analytics'].includes(module.name)) {
//             permissions = { canView: true, canCreate: true, canEdit: true, canDelete: true };
//           }
//           break;
//         case 'teacher':
//           if (['Dashboard', 'Attendance Management', 'Grade Management', 'Timetable Management', 'Communication Portal'].includes(module.name)) {
//             permissions = { canView: true, canCreate: true, canEdit: true, canDelete: false };
//           }
//           break;
//         case 'student':
//           if (['Dashboard', 'Grade Management', 'Attendance Management', 'Timetable Management', 'Fee Management', 'Library Management'].includes(module.name)) {
//             permissions = { canView: true, canCreate: false, canEdit: false, canDelete: false };
//           }
//           break;
//         case 'parent':
//           if (['Dashboard', 'Grade Management', 'Attendance Management', 'Fee Management', 'Communication Portal'].includes(module.name)) {
//             permissions = { canView: true, canCreate: false, canEdit: false, canDelete: false };
//           }
//           break;
//         case 'accountant':
//           if (['Dashboard', 'Fee Management', 'HR & Payroll', 'Reports & Analytics'].includes(module.name)) {
//             permissions = { canView: true, canCreate: true, canEdit: true, canDelete: false };
//           }
//           break;
//         case 'librarian':
//           if (['Dashboard', 'Library Management', 'Inventory Management'].includes(module.name)) {
//             permissions = { canView: true, canCreate: true, canEdit: true, canDelete: true };
//           }
//           break;
//       }
...
//       lastName: 'Admin',
//       phone: '+1234567890',
//       roleId: allRoles.find(r => r.name === 'super_admin').id,
//     },
//   });
...
//       phone: '+1234567891',
//       roleId: allRoles.find(r => r.name === 'admin').id,
//     },
//   });
...
//       lastName: 'Smith',
//       phone: '+1234567892',
//       roleId: allRoles.find(r => r.name === 'teacher').id,
//     },
//   });
